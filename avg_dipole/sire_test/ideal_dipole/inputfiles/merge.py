...
#Script to merge sodium topology with ideal dipole. 
#Usage: python merge.py  na.prmtop na.rst7 dipole.prmtop dipole.rst7
import parmed
...
print("Adding sodium to dipole topology...")
